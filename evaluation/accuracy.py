...
def parse_arguments():
    ...
    parser.add_argument('--model_name', default='Qwen2VL-mv16', type=str, help='Model name.')
    parser.add_argument('--output_json', default='output/qwen2vl-voting-16.json', type=str, help='Output json.')
    ...
    parser.add_argument('--main_results_csv_path', default='result/qwen2vl-voting/accuracy-16.csv', type=str, help='Path to save the main results CSV file.')
