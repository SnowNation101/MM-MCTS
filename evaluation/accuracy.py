...
def parse_arguments():
    ...
    parser.add_argument('--model_name', default='Qwen2VL-SC', type=str, help='Model name.')
    parser.add_argument('--output_json', default='output/qwen2vl-sc.json', type=str, help='Output json.')
    ...
    parser.add_argument('--main_results_csv_path', default='result/qwen2vl/accuracy-sc.csv', type=str, help='Path to save the main results CSV file.')
